<!--
  KB : copie traduite de frappe-ui/frappe/Onboarding/OnboardingSteps.vue (frappe-ui 1.0.0-beta.3).
...
<template>
  <div class="flex flex-col justify-center items-center gap-1 mt-4 mb-7">
    ...
    <div class="text-p-base font-normal">
      {{ __('{0}/{1} steps completed', String(stepsCompleted), String(totalSteps)) }}
    </div>
  </div>
  <div class="flex flex-col gap-2.5 overflow-hidden">
    <div class="flex justify-between items-center py-0.5">
      <Badge
        :label="__('{0}% completed', String(completedPercentage))"
